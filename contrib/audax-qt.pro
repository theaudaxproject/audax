...
RESOURCES += src/qt/audax.qrc src/qt/audax_locale.qrc

TRANSLATIONS += src/qt/locale/audax_bg.ts \
                src/qt/locale/audax_de.ts \
                src/qt/locale/audax_en.ts \
                src/qt/locale/audax_es.ts \
                src/qt/locale/audax_fi.ts \
                src/qt/locale/audax_fr.ts \
                src/qt/locale/audax_it.ts \
                src/qt/locale/audax_ja.ts \
                src/qt/locale/audax_pl.ts \
                src/qt/locale/audax_pt.ts \
                src/qt/locale/audax_ru.ts \
                src/qt/locale/audax_sk.ts \
                src/qt/locale/audax_sv.ts \
                src/qt/locale/audax_vi.ts \
                src/qt/locale/audax_zh_CN.ts \
                src/qt/locale/audax_zh_TW.ts
