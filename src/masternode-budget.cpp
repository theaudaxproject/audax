...
CAmount CBudgetManager::GetTotalBudget(int nHeight)
{
	...
	if (nHeight > 480 && nHeight < 9675001) { //mainnet budget available after block 1000
...
void CBudgetManager::NewBlock()
{
    ...
    if (masternodeSync.RequestedMasternodeAssets <= MASTERNODE_SYNC_BUDGET && Params().NetworkID() != CBaseChainParams::REGTEST) return;
