...
static const CRPCCommand vRPCCommands[] =
    {
        ...
        /* Audax features */
        {"audax", "masternode", &masternode, true, true, false},
        {"audax", "listmasternodes", &listmasternodes, true, true, false},
        {"audax", "createmasternodebroadcast", &createmasternodebroadcast, true, true, false},
        {"audax", "decodemasternodebroadcast", &decodemasternodebroadcast, true, true, false},
        {"audax", "relaymasternodebroadcast", &relaymasternodebroadcast, true, true, false},
        {"audax", "getmasternodecount", &getmasternodecount, true, true, false},
        {"audax", "masternodeconnect", &masternodeconnect, true, true, false},
        {"audax", "masternodecurrent", &masternodecurrent, true, true, false},
        {"audax", "masternodedebug", &masternodedebug, true, true, false},
        {"audax", "startmasternode", &startmasternode, true, true, false},
        {"audax", "createmasternodekey", &createmasternodekey, true, true, false},
        {"audax", "getmasternodeoutputs", &getmasternodeoutputs, true, true, false},
        {"audax", "listmasternodeconf", &listmasternodeconf, true, true, false},
        {"audax", "getmasternodestatus", &getmasternodestatus, true, true, false},
        {"audax", "getmasternodewinners", &getmasternodewinners, true, true, false},
        {"audax", "getmasternodescores", &getmasternodescores, true, true, false},
        {"audax", "mnbudget", &mnbudget, true, true, false},
        {"audax", "preparebudget", &preparebudget, true, true, false},
        {"audax", "submitbudget", &submitbudget, true, true, false},
        {"audax", "mnbudgetvote", &mnbudgetvote, true, true, false},
        {"audax", "getbudgetvotes", &getbudgetvotes, true, true, false},
        {"audax", "getnextsuperblock", &getnextsuperblock, true, true, false},
        {"audax", "getbudgetprojection", &getbudgetprojection, true, true, false},
        {"audax", "getbudgetinfo", &getbudgetinfo, true, true, false},
        {"audax", "mnbudgetrawvote", &mnbudgetrawvote, true, true, false},
        {"audax", "mnfinalbudget", &mnfinalbudget, true, true, false},
        {"audax", "checkbudgets", &checkbudgets, true, true, false},
        {"audax", "mnsync", &mnsync, true, true, false},
        {"audax", "spork", &spork, true, true, false},
        {"audax", "getpoolinfo", &getpoolinfo, true, true, false},
        {"audax", "makekeypair", &makekeypair, true, true, false},
#ifdef ENABLE_WALLET
        /* Wallet */
...
{
    return "> audax-cli " + methodname + " " + args + "\n";
}
