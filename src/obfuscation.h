...
{
public:
    /// Is the inputs associated with this public key? (and there is 150000 AUDAX - checking if valid masternode)
...
public:
    ...
    /// Get the denominations for a specific amount of audax.
