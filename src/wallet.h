...
enum AvailableCoinsType {
    ALL_COINS = 1,
    ONLY_DENOMINATED = 2,
    ONLY_NOT150000IFMN = 3,
    ONLY_NONDENOMINATED_NOT150000IFMN = 4, // ONLY_NONDENOMINATED and not 150000 AUDAX at the same time
    ONLY_150000 = 5,                        // find masternode outputs including locked ones (use with caution)
