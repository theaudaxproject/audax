...
/** Utility functions used by the Audax Qt UI.
 */
namespace GUIUtil
{
...
// Render Audax addresses in monospace font
...
// Parse "audax:" URI into recipient object, return true on successful parsing
