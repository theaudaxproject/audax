                                                                            ...
                                                                            spinnerFrame(0)
{
    ...
    QString windowTitle = tr("Audax Core") + " - ";
#ifdef ENABLE_WALLET
...
void BitcoinGUI::createActions(const NetworkStyle* networkStyle)
{
    ...
    sendCoinsAction->setStatusTip(tr("Send coins to a Audax address"));
    ...
    receiveCoinsAction->setStatusTip(tr("Request payments (generates QR codes and audax: URIs)"));
    ...
    aboutAction = new QAction(networkStyle->getAppIcon(), tr("&About Audax Core"), this);
    aboutAction->setStatusTip(tr("Show information about Audax Core"));
    ...
    optionsAction->setStatusTip(tr("Modify configuration options for Audax"));
    ...
    signMessageAction->setStatusTip(tr("Sign messages with your Audax addresses to prove you own them"));
    verifyMessageAction = new QAction(QIcon(":/icons/transaction_0"), tr("&Verify message..."), this);
    verifyMessageAction->setStatusTip(tr("Verify messages to ensure they were signed with specified Audax addresses"));
    ...
    openAction->setStatusTip(tr("Open a Audax: URI or payment request"));
    openBlockExplorerAction = new QAction(QIcon(":/icons/explorer"), tr("&Blockchain explorer"), this);
    openBlockExplorerAction->setStatusTip(tr("Block explorer window"));

    showHelpMessageAction = new QAction(QApplication::style()->standardIcon(QStyle::SP_MessageBoxInformation), tr("&Command-line options"), this);
    showHelpMessageAction->setMenuRole(QAction::NoRole);
    showHelpMessageAction->setStatusTip(tr("Show the Audax Core help message to get a list with possible Audax command-line options"));
...
void BitcoinGUI::createTrayIcon(const NetworkStyle* networkStyle)
{
    ...
    QString toolTip = tr("Audax Core client") + " " + networkStyle->getTitleAddText();
...
void BitcoinGUI::setNumConnections(int count)
{
    ...
    labelConnectionsIcon->setToolTip(tr("%n active connection(s) to Audax network", "", count));
}
...
{
    QString strTitle = tr("Audax Core"); // default title
