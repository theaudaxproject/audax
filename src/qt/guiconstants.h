...
/* Audax GUI -- Size of icons in status bar */
...
#define QAPP_ORG_NAME "Audax"
#define QAPP_ORG_DOMAIN "audax.org"
#define QAPP_APP_NAME_DEFAULT "Audax-Qt"
#define QAPP_APP_NAME_TESTNET "Audax-Qt-testnet"
