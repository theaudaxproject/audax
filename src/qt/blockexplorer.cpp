...
static std::string ValueToString(CAmount nValue, bool AllowNegative = false)
{
    ...
    QString Str = BitcoinUnits::formatWithUnit(BitcoinUnits::AUDAX, nValue);
...
void BlockExplorer::showEvent(QShowEvent*)
{
    if (m_NeverShown) {
        ...
        if (!GetBoolArg("-txindex", true)) {
            QString Warning = tr("Not all transactions will be shown. To view all transactions you need to set txindex=1 in the configuration file (audax.conf).");
            QMessageBox::warning(this, "Audax Core Blockchain Explorer", Warning, QMessageBox::Ok);
        }
    }
}
...
{
    QString CSS = "body {font-size:12px; color:#f8f6f6; bgcolor:#9932cc;}\n a, span { font-family: monospace; }\n span.addr {color:#9932cc; font-weight: audax;}\n table tr td {padding: 3px; border: 1px solid black; background-color: #9932cc;}\n td.d0 {font-weight: audax; color:#f8f6f6;}\n h2, h3 { white-space:nowrap; color:#9932cc;}\n a { color:#88f6f6; text-decoration:none; }\n a.nav {color:#9932cc;}\n";
