Contributing to Audax Core
============================

The Audax Core project operates an open contributor model where anyone is
...
The following applies to code changes to the Audax Core project, and is not to be
confused with overall Audax Network Protocol consensus changes.

Whether a pull request is merged into Audax Core rests with the project merge
...
Patches that change Audax consensus rules are considerably more involved than
...
Where a patch set proposes to change the Audax consensus, it must have been
...
The project leader is the release manager for each Audax Core release.
