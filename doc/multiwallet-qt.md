...
In order to support loading of multiple wallets in audax-qt, a few changes in the UI architecture will be needed.
...
Only requiring some minor changes is audax.cpp.
...
Changes to audax.cpp
----------------------
audax.cpp is the entry point into audax-qt, and as such, will require some minor modifications to provide hooks for
